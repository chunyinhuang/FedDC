...
train_dir = '/media/oem/4T/chest_xray/train'
val_dir = '/media/oem/4T/chest_xray/val'
test_dir = '/media/oem/4T/chest_xray/test'


def init_CXR(root = '/media/oem/4T', mode = 'train'):
    ...
    data_dir = os.path.join(root, 'chest_xray', mode)
    dataset = ImageFolder([data_dir], loader=Image.open, preload_size=(3, 224, 224),
...
if __name__ == '__main__':
    ...
    ll = [0, 1, 2, len(trainset)-1, len(trainset)-2, len(trainset)-3]
    for i in ll:
        print(trainset[i][1])
