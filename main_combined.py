        ...
        for it in range(1, args.Iteration+1):
            ...
            for ol in range(args.outer_loop):
                ...
                for c in range(num_classes):
                    ...
                    # for ii in range(30):
                    #     output_syn = net(img_syn)
                    #     loss += criterion_syn(output_syn, img_real[ii*args.ipc:(ii+1)*args.ipc])/30
                ...
                label_real_all = torch.cat(label_real_all, dim=0)
                # print(image_real_all.size(), label_real_all.size())
            ...
            if it%10 == 0:
                print('%s iter = %04d, loss = %.4f, AE loss on real set = %.4f' % (get_time(), it, loss_avg, loss_ae))
